...
class STELLAR:
    ...
    def __init__(self, args, dataset):
        ...
        if args.model == "GraphSAGE":
            ...
            self.model = models.FCNet(args.input_dim, args.num_heads)
        elif args.model == "GAT":
            self.model = models.Encoder_with_Attention(args.input_dim, args.num_heads)
        elif args.model == "Transformers":
            self.model = models.Encoder_with_Transformer(args.input_dim, args.num_heads)
        elif args.model == "GCN":
            self.model = models.GCNEncoder(args.input_dim, args.num_heads)
        else:
            raise("model type not identified")
        #self.model = models.Encoder(args.input_dim, args.num_heads)
        #self.model = models.FCNet(args.input_dim, args.num_headsNet)
